...
#ifdef CHANGED
    processNumber = 0;
    semaphoreProcessNumber = new Semaphore("number of process", 1);
#endif // CHAGNED
...
#ifdef CHANGED
// Incremente le nombre de processus. Est thread safe.
void Machine::addProcess()
{
    semaphoreProcessNumber->P();
    processNumber++;
    semaphoreProcessNumber->V();
    DEBUG('x', "Nombre de processus %d\n", processNumber);
}

// Decremente le nombre de processus. Est thread safe.
void Machine::removeProcess()
{
    semaphoreProcessNumber->P();
    if (processNumber > 0)
        processNumber--;
